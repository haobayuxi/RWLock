...
//   node_id_t machine_num =
//   (node_id_t)client_conf.get("machine_num").get_int64(); node_id_t machine_id
//   = (node_id_t)client_conf.get("machine_id").get_int64(); t_id_t
...
//     param_arr[i].thread_global_id = (machine_id * thread_num_per_machine) +
//     i; param_arr[i].coro_num = coro_num; param_arr[i].bench_name =
//     bench_name; param_arr[i].global_meta_man = global_meta_man;
...
//   s = "sed -i '7c \"write_ratio\": " + write_ratio + ",' " +
//   workload_filepath; system(s.c_str());
// }
...
//   } else {
//     thread_num_coro_num =
//         std::to_string(thread_num_per_machine) + "_" +
//         std::to_string(coro_num);
//   }
...
//     param_arr[i].thread_local_id = i;
//     param_arr[i].thread_global_id = (machine_id * thread_num_per_machine) +
//     i; param_arr[i].coro_num = coro_num; param_arr[i].global_meta_man =
//     global_meta_man; param_arr[i].global_status = global_vcache;
//     param_arr[i].global_lcache = global_lcache;
//     param_arr[i].global_rdma_region = global_rdma_region;
//     param_arr[i].thread_num_per_machine = thread_num_per_machine;
//     param_arr[i].total_thread_num = thread_num_per_machine * machine_num;
