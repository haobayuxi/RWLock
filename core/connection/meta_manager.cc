...
//   if (client_socket < 0) {
//     RDMA_LOG(ERROR) << "MetaManager creates socket error: " <<
//     strerror(errno); close(client_socket); return -1;
//   }
...
//       // if (backup_hash_metas.find(meta.table_id) ==
//       backup_hash_metas.end()) {
